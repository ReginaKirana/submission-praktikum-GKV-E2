...
void render()
{
    ...
    // Render sumber cahaya sebagai titik
...
{
    if (c == 27) exit(0);         // ESC key
    else if (c == 's') l[1] -= 5.0;  // Gerakkan cahaya ke bawah
    else if (c == 'w') l[1] += 5.0;  // Gerakkan cahaya ke atas
    else if (c == 'a') l[0] -= 5.0;  // Gerakkan cahaya ke kiri
    else if (c == 'd') l[0] += 5.0;  // Gerakkan cahaya ke kanan
    else if (c == 'q') l[2] -= 5.0;  // Gerakkan cahaya ke depan
    else if (c == 'e') l[2] += 5.0;  // Gerakkan cahaya ke belakang
    else if (c == 'h') help();
}
